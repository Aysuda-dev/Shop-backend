...
class ArticleCategory(models.Model):
    ...
    is_active = models.BooleanField(default=True, verbose_name=' فعال/غیرعال')
...
class Article(models.Model):
    ...
    images= models.ImageField(upload_to='articles', verbose_name='تصویر مقاله')
    short_description=models.TextField(verbose_name='توضیحات کوتاه')
    text=models.TextField(verbose_name='متن مقاله')
    category=models.ManyToManyField('ArticleCategory', verbose_name='دسته بندی ها')
    is_active = models.BooleanField(default=True, verbose_name=' فعال/غیرعال')
