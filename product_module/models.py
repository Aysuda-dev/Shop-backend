...
class ProductVariant(models.Model):
    product = models.ForeignKey(Products, on_delete=models.CASCADE, verbose_name="محصول" ,related_name='variants')
...
class ProductGallery(models.Model):
    ...
    image = models.ImageField(upload_to='images/product-gallery', null=True, blank=True, verbose_name='توصویر')
    def __str__(self):
